...
export async function initConfig(): Promise<void> {
  try {
    ...
    console.log(chalk.blue('📝 You can now customize your utility configuration'));
    console.log(chalk.gray('   Edit the path and aliases to match your project structure'));
  } catch (error) {
